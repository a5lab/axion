...
//    technologyBlip.setRadar();
//    technologyBlip.setTechnology("My website");
//    technologyBlip.setSegment("My technologyBlip description");
//    technologyBlip.setRing(0);
...
//    Assertions.assertEquals(technologyBlipDtoCollection.iterator().next().getTitle(), technologyBlip.getTitle());
//    Assertions.assertEquals(technologyBlipDtoCollection.iterator().next().getDescription(),
//        technologyBlip.getDescription());
//
//  }
//  /*
//  @Test
